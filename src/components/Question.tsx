...
import materi_symbol_down from '../img-page/materi_symbols_down.webp'


const Question = () => {
    return(
    <section>  
        <div className="flex flex-wrap xl:flex-nowrap justify-center p-4 2xl:p-0 mt-[100px]">
            <h2 className="text-5xl te lg:text-3xl mb-10  font-semibold text-[#002157] mt-[15px] lg:mr-[100px] lg:ml-[150px]">FAG</h2>
            <div className=" w-[1381px]  rounded-[10px] bg-[#F8FCFF]"> 
